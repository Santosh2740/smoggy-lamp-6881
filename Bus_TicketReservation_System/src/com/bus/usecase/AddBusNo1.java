...
public class AddBusNo1 {
	public static void AddBus() {
		...
		try {
			...
			sc.nextLine();
			System.out.print(ConsoleColor.ORANGE + "Enter Departure date and time in format (YYYY-MM-DD HH:MI:SS) : "
					+ ConsoleColor.RESET);
			String departure = sc.nextLine();

			System.out.print(ConsoleColor.ORANGE + "Enter Arrival date and time in format (YYYY-MM-DD HH:MI:SS) : "
					+ ConsoleColor.RESET);
